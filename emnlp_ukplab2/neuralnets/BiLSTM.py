...
class BiLSTM:
    ...
    def buildModel(self):
        ...
        tokens = Embedding(input_dim=self.embeddings.shape[0], output_dim=self.embeddings.shape[1], weights=[self.embeddings], trainable=self.params['wordEmbeddings_trainable'], name='word_embeddings')(tokens_input)
