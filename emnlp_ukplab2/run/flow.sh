...
if [ $1 = "bbn_kn" ];
then
    rm /datastore/liu121/nosqldb2/emnlp_ukplab/data/pkl/bbn_kn*
...
then
    rm /datastore/liu121/nosqldb2/emnlp_ukplab/data/pkl/cadec*
...
then
    rm /datastore/liu121/nosqldb2/emnlp_ukplab/data/pkl/nvd*
